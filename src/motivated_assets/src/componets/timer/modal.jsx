...
function Example(props) {
    ...
    return (
        <>
            <h1 style={{color: "fff", textShadow: " 0 0 7px #ADD8E6,  0 0 10px #ADD8E6,  0 0 21px #ADD8E6 "}}>Click To Acheive Your Goal</h1> 
            <Button  onClick={handleShow} style={{marginTop: "80px", backgroundColor: "lightblue"}} >
